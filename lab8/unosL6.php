...
$app->post('/ispisL6/', function() use ($app) {
    ...
    $app->view()->setData(array('Naziv_proizvoda' =>$naziv, 'Tip_proizvoda' =>$tip, 'Opis_proizvoda' =>
	$opis, 'Vegetarijanski' => $vegetarijanski, 'Halal' => $halal, 'Košer'=>$koser,'Alergeni'=>$alergeni , 
	'Cijena' => $cijena));
